...
// ==========================================
// MODAL DE ENDEREÇOS COM GESTÃO (CRUD)
// ==========================================
  ...
  modal.innerHTML = `
    <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 9999; display: flex; justify-content: center; align-items: center; padding: 20px;">
      <div style="background: #202024; padding: 25px; border-radius: 16px; width: 100%; max-width: 450px; border: 1px solid #323238; max-height: 90vh; overflow-y: auto;">
        ...
        <input type="text" id="input-cep" placeholder="CEP (00000-000)" onkeyup="mascaraCEP(this)" oninput="desmarcarRadios()" style="width: 100%; padding: 12px; background: #121214; border: 1px solid #323238; color: #f5f5f5; border-radius: 8px; margin-bottom: 10px;">
...
// ==========================================
// RESTO DO PERFIL (AVALIAÇÃO E DADOS)
// ==========================================
...
async function alterarSenha() {
  ...
  try {
    ...
    const d = await res.json(); if (res.ok) { showToast(d.mensagem, "success"); }
  } catch(e) {}
}
